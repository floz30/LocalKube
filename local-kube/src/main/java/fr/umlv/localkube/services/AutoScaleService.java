...
public class AutoScaleService {
    ...
    private void scaleAll() {
        instances.forEach((key, value) -> {
            applicationService.findIdByName(key).ifPresentOrElse(id -> scaleExistingApplication(applicationService.findById(id).get(), value), () -> scaleNewApplication(key, value));
        });
    }
